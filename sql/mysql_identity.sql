...
CREATE USER IF NOT EXISTS 'identitydbuser' IDENTIFIED BY 'identitydbuserpassword';
GRANT INSERT, UPDATE, DELETE, SELECT ON WSO2IS_IDENTITY_DB.* TO 'identitydbuser'@'%' IDENTIFIED BY 'identitydbuserpassword';
