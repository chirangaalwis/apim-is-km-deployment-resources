...
CREATE USER IF NOT EXISTS 'consentdbuser' IDENTIFIED BY 'consentdbuserpassword';
GRANT INSERT, UPDATE, DELETE, SELECT ON WSO2IS_CONSENT_DB.* TO 'consentdbuser'@'%' IDENTIFIED BY 'consentdbuserpassword';
