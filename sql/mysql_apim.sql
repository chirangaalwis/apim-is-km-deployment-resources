...
CREATE USER IF NOT EXISTS 'amdbuser' IDENTIFIED BY 'amdbuserpassword';
GRANT INSERT, UPDATE, DELETE, SELECT ON WSO2AM_DB.* TO 'amdbuser'@'%' IDENTIFIED BY 'amdbuserpassword';
