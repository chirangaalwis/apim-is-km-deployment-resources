...
CREATE USER IF NOT EXISTS 'bpsdbuser' IDENTIFIED BY 'bpsdbuserpassword';
GRANT INSERT, UPDATE, DELETE, SELECT ON WSO2IS_BPS_DB.* TO 'bpsdbuser'@'%' IDENTIFIED BY 'bpsdbuserpassword';
