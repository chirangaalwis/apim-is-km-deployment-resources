...
CREATE USER IF NOT EXISTS 'shareddbuser' IDENTIFIED BY 'shareddbuserpassword';
GRANT INSERT, UPDATE, DELETE, SELECT ON WSO2AM_SHARED_DB.* TO 'shareddbuser'@'%' IDENTIFIED BY 'shareddbuserpassword';
